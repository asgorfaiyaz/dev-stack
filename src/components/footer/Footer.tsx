    ...
    <footer className="pb-10 px-2">
      <div className="flex justify-between gap-10 pb-10 container mx-auto">
        <div className="flex flex-col gap-3 items-center md:items-start w-full md:max-w-90 pb-5">
          ...
          <p className="text-muted text-[12px] text-center md:text-left">
            Curated tools, technologies, and resources for developers building
            modern software.
          </p>
          <ul className="flex gap-5 md:pt-3 text-[12px] text-muted list-disc md:list-none">
      ...
      <div className="text-[11px] text-muted border-t-2 border-t-[#F3F4F6] pt-4 md:pt-10">
